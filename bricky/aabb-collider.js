/* global AFRAME, THREE */
/* aabb-colider, with a modification to avoid a bug when removing a component.
 *   See https://github.com/supermedium/superframe/pull/285
 */ 
...
AFRAME.registerComponent('aabb-collider', {
  ...
  remove: function () {
    ...
    if (this.data.debug) {
      if (this.boxHelper) {
        el.sceneEl.object3D.remove(this.boxHelper);
        this.boxHelper = null;
      };
